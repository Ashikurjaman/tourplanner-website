...
const MyOrders = (id) => {
    ...
    useEffect(() => {
        const url = "https://limitless-dawn-39820.herokuapp.com/setplan"
        fetch(url)
            .then(res => res.json())
    ...
    const handleDelete = id => {
        const url = `https://limitless-dawn-39820.herokuapp.com/setplan/${id}`
        fetch(url, {
            method: 'DELETE'
        })
            .then(res => res.json())
        ...
        <div>
            ...
            <TableContainer component={Paper}>
                <Table data-aos="zoom-in-up" aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell data-aos="zoom-in-up">Package title</TableCell>
